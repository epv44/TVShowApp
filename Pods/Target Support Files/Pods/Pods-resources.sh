...
if [[ "$CONFIGURATION" == "Development" ]]; then
  ...
  install_resource "AWSLambda/AWSLambda/Resources/lambda-2015-03-31.json"
  install_resource "AWSMachineLearning/AWSMachineLearning/Resources/machinelearning-2014-12-12.json"
